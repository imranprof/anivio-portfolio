...
const RotatingSection = () => {
  ...
  return (
    <section id="rotateParentContainer" className=" w-full h-[1016px] flex justify-center relative overflow-hidden">
      ...
      <div className=" w-full h-[1480px] absolute top-1/3 left-0">
        ...
        <div id="rotatingContainer" className="w-full h-full flex justify-center">
          <div className="list-item1 z-[2] absolute translate-y-[-50%]">
            <div className=" py-2  px-4 rounded-[98px] border border-[#883237] bg-white ">
              How Pryme Works
            </div>
          </div>
          <div className="list-item2 z-[10] absolute -rotate-90 top-1/2 left-0 translate-x-[-50%] translate-y-[-50%]">
            <div className=" py-2  px-4 rounded-[98px] border border-[#883237] bg-white ">
              How Pryme Works2
            </div>
          </div>
          <div className="list-item3 z-[10] absolute rotate-180 bottom-0 left-1/2 translate-x-[-50%] translate-y-[50%]">
            <div className=" py-2  px-4 rounded-[98px] border border-[#883237] bg-white ">
              How Pryme Works3
            </div>
          </div>
