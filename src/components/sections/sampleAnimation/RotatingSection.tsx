...
const RotatingSection = () => {
  ...
  return (
    <section id="rotateParentContainer" className=" w-full h-[1016px] flex justify-center relative overflow-hidden">
      ...
      <div className=" w-full h-[1480px] absolute top-1/3 left-0 flex justify-center">
        ...
        <div id="rotatingContainer" className=" border border-[#883237] rounded-full h-full  aspect-square flex justify-center">
          <div className="rotate-card list-item1 z-[2] absolute translate-y-[-50%]">
            ...
            <div className="step-card step1-card absolute mt-[80px] w-[318px] h-[276px] top-0 left-1/2 translate-x-[-50%] rounded-[16px] border border-[#883237]">
          ...
          <div className="rotate-card opacity-0 list-item2 z-[10] absolute -rotate-90 top-1/2 left-0 translate-x-[-50%]">
            <div className=" py-2  px-4 rounded-[98px] border border-[#883237] bg-white ">
              How Pryme Works2
            </div>
            <div className="step-card step2-card  absolute  mt-[80px] w-[318px] h-[276px] top-0 left-1/2 translate-x-[-50%] rounded-[16px] border border-[#883237]">
              <div className="h-full flex flex-col justify-between p-6 items-center">
          ...
          <div className="rotate-card opacity-0 list-item3 z-[10] absolute rotate-180 bottom-0 left-1/2 translate-x-[-50%] translate-y-[50%]">
            <div className=" py-2  px-4 rounded-[98px] border border-[#883237] bg-white ">
              How Pryme Works3
            </div>
            <div className="step-card step3-card  absolute mt-[80px] w-[318px] h-[276px] top-0 left-1/2 translate-x-[-50%] rounded-[16px] border border-[#883237]">
              <div className="h-full flex flex-col justify-between p-6 items-center">
