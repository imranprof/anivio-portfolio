...
const ProjectHero = () => {
  ...
  return (
    <section ref={containerRef} className="container flex flex-col font-poppin h-[calc(100vh-120px)]">
      ...
      <div className="flex flex-col items-center">
        <div className="flex justify-center items-center my-20 py-20">
          ...
          <h1 className="has-text-reveal text-[clamp(64px,15vw,300px)] font-bold px-[80px]" >
            Projects
          </h1>
